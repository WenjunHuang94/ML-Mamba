...
from mlmamba.models.backbones.vision import (
    CLIPViTBackbone,
    DinoCLIPViTBackbone,
...
def get_llm_backbone_and_tokenizer(
    ...
    if llm_backbone_id in LLM_BACKBONES:
        ...
        llm_backbone: LLMBackbone = llm_cfg["cls"](  # mlmamba.models.backbones.llm.mamba.MambaLLMBackbone
            llm_backbone_id,
            llm_max_length=llm_max_length,  # 2048
            hf_token=hf_token,
            inference_mode=inference_mode,  # Pass False during training and True during generate
            **llm_cfg["kwargs"],
        )
