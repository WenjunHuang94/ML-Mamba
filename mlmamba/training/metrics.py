...
class Metrics:  # This code defines a class called Metrics, which is used to track and record various metrics during the training process, such as loss, learning rate, etc. This class is mainly used to collect and record training metrics in distributed training environments, and write these metrics into different types of trackers (such as JSONLines files or Weights&Biases)
    def __init__(
        self,
        ...
        for tracker_type in active_trackers:
            if tracker_type == "jsonl" or tracker_type == "wandb":
