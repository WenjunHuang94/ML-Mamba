...
from mlmamba.training.strategies.base_strategy import TrainingStrategy
...
class FSDPStrategy(TrainingStrategy):
    ...
    def save_checkpoint(
        ...
        with FSDP.state_dict_type(self.vlm, self.fsdp_state_dict_type, self.fsdp_save_policy):
            ...
            model_state_dicts = {
                ...
                "mlp": {k[len("mlp."):]: v for k, v in full_vlm_state_dict.items() if
                              k.startswith("mlp.")},
            ...
            if overwatch.is_rank_zero():
                ...
                #shutil.copy(checkpoint_path, checkpoint_dir / "vlm_projector_mamba2_2.7b_0810.pth")
    ...
    def run_setup(self, run_dir: Path, n_train_examples: int) -> None:
        ...
        if self.enable_mixed_precision_training and self.mixed_precision_dtype == torch.bfloat16: # Enter this when turning on mixed precision
        ...
        if self.lr_scheduler_type == "linear-warmup+cosine-decay":
            ...
            decay, no_decay = [], []
            for name, param in self.vlm.named_parameters():  # Group the parameters of the model into those that require weight decay (decay) and those that do not require weight decay (no_decay)
