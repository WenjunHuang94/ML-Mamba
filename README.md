...
[![Demo](https://img.shields.io/badge/Demo-mlmamba-blue.svg?style=for-the-badge)](https://huggingface.co/spaces/han1997/mlmamba)

<img src="assets/mlmamba.png" width="200px">

(Generated by SDXL, prompt: A cute mlmamba with flamming lava in the background, cartoon style)

## Release
[5/23] A fix for the prompt format, which modifies the abnormal behavior during generation, has been implemented. Make sure you use the newest [checkpoint](https://huggingface.co/han1997/mlmamba) to adapt to the new prompt format!

[5/18] The [evaluation](https://github.com/h-zhao1997/vlm-evaluation) code has been uploaded!

[3/27] An intuitive demo, showcasing the generation speed of our MLMamba model and LLaVA v1.5.
<img src="assets/mlmamba_demo.gif">

[3/24] Try our [demo](https://huggingface.co/spaces/han1997/mlmamba) online!

[3/24] The training and inference codes are released.

[3/24] Our model [weight](https://huggingface.co/han1997/mlmamba) is available now.
...
`pip install git+https://github.com/h-zhao1997/mlmamba`):

```bash
git clone https://github.com/h-zhao1997/mlmamba
cd mlmamba
pip install -e .
...
Once installed, loading and running inference with pretrained `mlmamba` models is easy:
...
Here's how you would train MLMamba follow the training recipe in our paper across 8 GPUs on a single-node: 
...
```bibtex
@article{zhao2024mlmamba,
      title={MLMamba: Extending Mamba to Multi-Modal Large Language Model for Efficient Inference}, 
